        ...
        <div className="max-w-4xl mx-auto">
          ...
          <Tabs defaultValue="business" className="w-full">
            <TabsList className="grid w-full grid-cols-1 md:grid-cols-4 h-auto gap-2 bg-transparent mb-6">
              <TabsTrigger
                value="business"
                className="data-[state=active]:bg-card data-[state=active]:shadow-sm py-2.5 border border-transparent data-[state=active]:border-border">
              ...
              <TabsContent value="business">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Configure core business operational parameters.
                    </CardDescription>
                  </CardHeader>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          <SelectContent>
                            <SelectItem value="USD">ZAR (R)</SelectItem>
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          type="number"
                          value={businessSettings.lowStock}
                          onChange={(e) =>
                            setBusinessSettings({
                              ...businessSettings,
                  ...
                  <CardContent className="space-y-6">
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(c) =>
                          setNotifications({ ...notifications, newOrders: c })
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Receive an email when a payment is recorded.
                        </p>
                      </div>
                      <Switch
                        checked={notifications.payments}
                        onCheckedChange={(c) =>
                          setNotifications({ ...notifications, payments: c })
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Receive an email when items fall below threshold.
                        </p>
                      </div>
                      <Switch
                        checked={notifications.lowStock}
                        onCheckedChange={(c) =>
                          setNotifications({ ...notifications, lowStock: c })
                        }
                      />
                    </div>
                    <div className="flex items-center justify-between">
